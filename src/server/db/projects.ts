...
const projects: Project[] = [
  {
    ...
    technologiesUsed: ['typescript', 'vuejs', 'nodejs', 'graphql', 'restapi', 'azure', 'kubernetes', 'docker', 'redis', 'mongodb', 'gitlab']
  },
  {
    slug: 'baumpub',
    ...
    // banner: 'https://picsum.photos/200/200',
    status: 'play',
    links: ['https://baumpub.com/', 'https://www.heavyequipmentguide.ca/', 'https://www.recyclingproductnews.com/'],
    // shortDescription: 'Lorem ipsum dolor sit amet.',
    technologiesUsed: ['typescript', 'vuejs', 'nuxt', 'gcp', 'nodejs', 'graphql', 'restapi', 'kubernetes', 'docker', 'redis', 'github', 'php', 'elasticsearch', 'mysql']
  },
  {
    slug: 'fillactive',
    name: 'Fillactive',
    ...
    status: 'stop',
    // shortDescription: 'Lorem ipsum dolor sit amet.',
    technologiesUsed: ['typescript', 'vuejs', 'nuxt', 'nodejs', 'graphql', 'restapi', 'digital-ocean', 'docker', 'redis', 'github', 'mysql']
  },
  {
    slug: 'megaswords',
    name: 'Megaswords',
    ...
    technologiesUsed: ['typescript', 'vuejs', 'nuxt', 'nodejs', 'graphql', 'restapi', 'digital-ocean', 'docker', 'redis', 'github', 'mysql', 'unity', 'csharp']
  },
//   {
//     slug: 'test',
...
//   },
  {
    ...
    status: 'stop',
    // shortDescription: 'Lorem ipsum dolor sit amet.',
    technologiesUsed: ['typescript', 'vuejs', 'nuxt', 'nodejs', 'graphql', 'digital-ocean', 'gcp', 'restapi', 'kubernetes', 'docker', 'redis', 'github', 'php', 'mysql']
  },
  {
    slug: 'canadiens',
    name: 'Canadiens',
    links: ['https://www.club1909.com/', 'https://fanclub.canadiens.com/', 'https://www.nhl.com/canadiens/fans/7thplayer'],
    // banner: 'https://picsum.photos/200/200',
    status: 'stop',
    // shortDescription: 'Lorem ipsum dolor sit amet.',
    technologiesUsed: ['nodejs', 'gcp', 'restapi', 'kubernetes', 'docker', 'redis', 'github', 'php', 'mysql']
  },
  {
    slug: 'lumenpulse',
    name: 'Lumenpulse',
    ...
    status: 'stop',
    // shortDescription: 'Lorem ipsum dolor sit amet.',
    technologiesUsed: ['vuejs', 'nodejs', 'gcp', 'restapi', 'kubernetes', 'docker', 'redis', 'github', 'php', 'elasticsearch', 'mysql']
  },
  {
    slug: 'monet',
    ...
    status: 'stop',
    // shortDescription: 'Lorem ipsum dolor sit amet.',
    technologiesUsed: ['typescript', 'vuejs', 'nuxt', 'nodejs', 'graphql', 'gcp', 'restapi', 'kubernetes', 'docker', 'redis', 'github', 'elasticsearch', 'mysql', 'rabbitmq']
  },
//   {
//     slug: 'nhlbet',
//     name: 'Nhl bet',
